    ...
    return (
      <Layout>
        ...
        <section className="bg-slate-950 py-14 text-white sm:py-16">
          <Container>
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-400">Careers at iRipple</p>
            <h1 className="mt-3 text-4xl font-semibold sm:text-5xl">Build Retail Technology That Matters</h1>
          </Container>
        </section>
